# Contributing to gulp-htmlmin-keep-closing-slash

First and foremost, thank you! We appreciate that you want to contribute to gulp-htmlmin-keep-closing-slash, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for gulp-htmlmin-keep-closing-slash**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for gulp-htmlmin-keep-closing-slash:

- star the [project](https://github.com/doowb/gulp-htmlmin-keep-closing-slash)
- tweet your support for gulp-htmlmin-keep-closing-slash
...
- **version**: please note the version of gulp-htmlmin-keep-closing-slash are you using
- **extensions, plugins, helpers, etc** (if applicable): please list any extensions you're using
- **error messages**: please paste any error messages into the issue, or a [gist](https://gist.github.com/)

### Closing issues

The original poster or the maintainer's of gulp-htmlmin-keep-closing-slash may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/gulp-htmlmin-keep-closing-slash
